...
import { GitProviderRepositoryValidatorDirective } from './create-app/gitprovider-createapp-step/gitprovider-repository.validator';
...
var LauncherModule = /** @class */ (function () {
    ...
    /** @nocollapse */
    LauncherModule.ctorParameters = function () { return []; };
    return LauncherModule;
}());
export { LauncherModule };
// Models
